...
TEST(tudbcpptest, BigIntMethodTest)
{
    ...
    ASSERT_EQ(case8.first[0], ~0ull);
    ASSERT_EQ(case8.first[1], 1);
    ASSERT_EQ(case8.second, true);
    ASSERT_EQ(case9.first[0], 1);
    ASSERT_EQ(case9.first[1], 0);
    ASSERT_EQ(case9.second, false);
}
