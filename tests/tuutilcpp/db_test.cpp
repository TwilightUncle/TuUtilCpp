...
TEST(TuutilcppDbTest, SqliteQueryTest)
{
    ...
    constexpr auto case1 = sqlite_query::make_type_name_string<db::bit>::value.data();
    constexpr auto case2 = sqlite_query::make_type_name_string<db::unsigned_bigint>::value.data();
    constexpr auto case3 = sqlite_query::make_type_name_string<db::varchar<0>>::value.data();
    constexpr auto case4 = sqlite_query::make_type_name_string<db::character<255>>::value.data();
